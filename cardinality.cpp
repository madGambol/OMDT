...
/* In a future release of Bison, this section will be replaced
   by #include "cardinality.hpp".  */
#ifndef YY_CC_CARDINALITY_HPP_INCLUDED
# define YY_CC_CARDINALITY_HPP_INCLUDED
/* Debug traces.  */
#ifndef YYDEBUG
# define YYDEBUG 0
#endif
...
#endif /* !YY_CC_CARDINALITY_HPP_INCLUDED  */
...
{
       0,    71,    71,    77,    83,    91,   109,   127,   136,   143,
     142,   160,   159,   169,   175,   190,   193,   196,   201,   208,
...
{
  "$end", "error", "$undefined", "eeNumber", "eeName", "eeOparen",
  "eeCparen", "eeComma", "eeColon", "eeDash", "eeElipses", "eePlus",
  "eeModulo", "eeEqual", "eeGreaterThan", "eeLessThan", "eeNotEqual",
  "eeGreaterOrEqual", "eeLessOrEqual", "$accept", "cardinalityExpression",
  "$@1", "$@2", "enumerateAltList", "enumerateAlternative", "comparison", YY_NULLPTR
};
#endif
...
{
       3,    -9,    -8,     8,    -1,     5,    22,    20,    -9,     4,
      -9,    -9,    21,    25,    -4,    -9,    -9,    -9,    -9,    -9,
      -9,    26,    19,    -9,    16,    -9,    27,    -9,    23,    28,
      29,    30,    -9,    31,    32,    -9,    -4,    -9,    34,    -9,
      33,    -9
};
...
{
       0,    14,     2,     9,     0,     0,     0,     3,    11,     0,
      13,     1,     4,     0,     0,    20,    21,    22,    23,    24,
      25,     0,     0,     7,    17,    16,     0,    10,     0,     0,
       0,    12,    19,     0,     0,    18,     0,     6,     0,    15,
       0,     5
};
...
{
      24,     6,    10,     7,     1,    11,     2,     3,    -8,    15,
      16,    17,    18,    19,    20,     4,     8,    15,    16,    17,
      18,    19,    20,    28,    29,    12,    30,    13,    22,    23,
      27,    32,    34,    35,    39,    37,    33,    36,    40,    41,
       0,     0,     0,     0,    21,    38
};

static const yytype_int8 yycheck[] =
{
       4,     9,     3,    11,     1,     0,     3,     4,     0,    13,
      14,    15,    16,    17,    18,    12,     8,    13,    14,    15,
      16,    17,    18,     4,     5,     3,    10,     7,     7,     4,
       4,     4,     4,     4,    36,     4,    13,     7,     4,     6,
      -1,    -1,    -1,    -1,     9,    13
};
...
{
       0,     1,     3,     4,    12,    20,     9,    11,     8,    21,
       3,     0,     3,     7,    22,    13,    14,    15,    16,    17,
      18,    25,     7,     4,     4,    24,    25,     4,     4,     5,
      10,    23,     4,    13,     4,     4,     7,     4,    13,    24,
       4,     6
};
...
yyreduce:
  ...
  case 4:
    ...
    {
  pType3  = new CType3( (yyvsp[-2]), (yyvsp[0]) );
  ...
  case 6:
    ...
    {
    // type 5a
    pType5a = new CType5a( (yyvsp[-2]) );
    
    pType5a->setComparisonType( e_Equal );

    pType5a->setEnumerateName( (yyvsp[0]) );
  ...
  case 17:
    ...
    {
  pType5b->addTerm( new SingleEnumerate( (yyvsp[0]) ) );
}
  ...
  case 18:
    ...
    {
  pType5b->addTerm( new EnumerateRange( (yyvsp[-2]), (yyvsp[0]) ) );
}
  ...
  case 19:
    ...
    {
  pType5b->addTerm( new EnumerateComparison( (yyvsp[-1]), (yyvsp[0]) ) );
}
