...
class PrettyPrint : public OMDTask
{
    ...
    //
    // do trailing comment on the block (for "(Class ...", ") ;; Class")
    //
    void blockEnd  ( const OMDBase * pItem, bool bTrailing = true );
